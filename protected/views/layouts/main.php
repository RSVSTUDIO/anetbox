...
<head>
    ...
    <link href="<?php echo Yii::app()->baseUrl; ?>/css/bootstrap3-wysiwyg5-color.css?ver=<?php echo $ver; ?>" rel="stylesheet">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">                    
                    ...
                    <div class="col-md-3">
                        <p class="copyrite pull-right"> &#169;AnetBox <?php echo(date('Y')); ?></p>
                    </div>
                </div>
            </div>
        </div>        
