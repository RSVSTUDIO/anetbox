...
class User extends HActiveRecordContentContainer implements ISearchable
{
    ...
    public function rules()
    {
        ...
        $rules = array();
        $rules[] = array('wall_id, status, group_id, super_admin, news_admin, created_by, updated_by', 'numerical', 'integerOnly' => true);
        $rules[] = array('email', 'email');
        $rules[] = array('guid', 'length', 'max' => 45);
        $rules[] = array('guid', 'exist', 'attributeName' => 'user_id', 'className' => 'UserSite');
        ...
        $rules[] = array('currency', 'length', 'max' => 3);
    ...
    public function relations()
    {
        return array(
            ...
            'userSite' => array(self::HAS_MANY, 'UserSite', ['user_id' => 'guid']),
            'user' => array(self::HAS_MANY, 'UserFriend', 'user_id'),
            'friend' => array(self::HAS_MANY, 'UserFriend', 'friend_id'),
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'super_admin' => Yii::t('UserModule.models_User', 'Super Admin'),
            'news_admin' => Yii::t('UserModule.models_User', 'News Admin'),
    ...
    public function getCurrency(){
        return (empty($this->currency) ? Currency::USD : $this->currency);
    }
